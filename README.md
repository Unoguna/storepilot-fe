...
StorePilot의 Next.js 프론트엔드입니다. 로그인/회원가입 화면, 상품 카테고리 분류 및 키워드 찾기, 결과 다운로드, 관리자 업로드 도구를 제공합니다.
...
- `POST /api/v1/product-excel-jobs/images/prepare`
- `POST /api/v1/product-excel-jobs/images/download`
